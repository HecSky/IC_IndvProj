...
def eval_ql(dataset: str, model_list: list, training_datasets: str):
    ...
    for model_name in model_list:
        ...
        total_rewards, trade_num, action_duration, action_rewards, rewards = ql_agent.test(env_test, return_res=True)
    ...
    plt.grid(True)
    plt.savefig("../figure/eval_ql_NL_" + dataset + ".png")
    plt.show()
...
if __name__ == "__main__":
    if True:
        ...
        f = open("../evaluation/eval_ql_NL_action_rewards_list.pkl", "wb")
        pickle.dump(action_rewards_list, f)
        f.close()
        print(result)
        f = open("../evaluation/eval_ql_NL_res.pkl", "wb")
